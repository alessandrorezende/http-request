$(document).ready(function(){
  ...
  $("#submitWithTime").click(function(event){
      App.doMethodRequestWithInterval();
  });
  ...
  $("#url").keypress(function(event){
      App.getURLHotKey(event);
  });

  $("#btn-stop-request").click(function(event){
      console.log("acionado botao stop request..");
      App.doMethodStopRequest();
  });
...
var App = {
	...
	RequestTransaction : function() {
		...
		this.url = null;
		this.requestHeaders = {}, this.contentType = null;
		this.content = null;
		this.parameters = {}
		this.filename = null;
		this.username = null;
